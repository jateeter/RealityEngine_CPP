...
#
# Options:
#   --target  <url>    RE runtime base URL  (default: http://localhost:5301)
#   --pe-target <url> PE runtime base URL  (default: http://localhost:5300)
...
RE_URL="http://localhost:5301"
PE_URL="http://localhost:5300"
SKIP_PE=0
SKIP_RE=0
VERBOSE=0
