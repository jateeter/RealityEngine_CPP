...
chain_a='{"version":"1.0.0","machine":{"name":"E2E Chain A","description":"First machine in PE-to-RE stream propagation test","arbiterRule":"PASSTHROUGH","perceptualMapping":{"input":{"offset":4600,"length":2},"output":{"offset":4602,"length":2}},"sequences":[{"id":"e2e-chain-a-seq","name":"A input stream emits B input","events":[{"id":"e2e-chain-a-start","elements":[{"value":1,"threshold":0.5},{"value":0,"threshold":0.5}],"isInitial":true,"nextEventIds":["e2e-chain-a-output"]},{"id":"e2e-chain-a-output","elements":[{"value":0,"threshold":0.5},{"value":1,"threshold":0.5}],"isInitial":false,"outputEvents":[{"id":"e2e-chain-a-out","vector":[1,0],"metadata":{"boundary":"A->B"}}]}]}]}}'
